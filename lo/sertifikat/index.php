...
<div class="container">
    ...
    <a href="<?= BASE_URL ?>lo/sertifikat/tambah.php" class="btn btn-primary btn-sm text-decoration-none text-white ms-4 mt-2 mb-4">Tambah Data Sertifikat</a>
</div>
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-nowrap">
                            <a href="<?= BASE_URL ?>lo/sertifikat/edit.php?id=<?= $sertifikat['id']; ?>" class="btn btn-sm btn-warning text-black">Edit</a>
