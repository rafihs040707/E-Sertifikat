...
// TEMPLATE PATH
// ======================
$templatePath = "uploads/template/" . $data['tampak_depan'];
...
$options->setChroot(__DIR__); // wajib untuk akses file lokal
