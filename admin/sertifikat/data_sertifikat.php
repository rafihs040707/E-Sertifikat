...
<div class="container">
    ...
    <form action="<?= BASE_URL ?>admin/sertifikat/cari_sertifikat.php" method="GET" class="col-sm-3 mb-3 ms-4 mt-4">
    ...
    <a href="<?= BASE_URL ?>admin/sertifikat/tambah_sertifikat.php" class="btn btn-primary btn-sm text-decoration-none text-white ms-4 mt-2 mb-4">Tambah Data Sertifikat</a>
</div>
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-nowrap">
                            <a href="<?= BASE_URL ?>admin/sertifikat/edit_sertifikat.php?id=<?= $sertifikat['id']; ?>" class="btn btn-sm btn-warning text-black">Edit</a>
                            ...
                            <a href="<?= BASE_URL ?>admin/sertifikat/hapus_sertifikat.php?id=<?= $sertifikat['id']; ?>" class="btn btn-sm btn-danger text-white" onclick="return confirm('Apakah yakin data sertifikat ini akan dihapus?');">Hapus</a>
                        </td>
                    </tr>
                <?php
                }
            ...
            <div class="card mb-2 border-primary shadow-sm">
                <div class="card-body p-2">
                    ...
                    <div class="d-flex gap-1 mt-2 flex-wrap">
                        ...
                        <a href="<?= BASE_URL ?>admin/sertifikat/hapus_sertifikat.php?id=<?= $sertifikat['id']; ?>" class="btn btn-sm btn-danger text-white w-100" onclick="return confirm('Apakah yakin data sertifikat ini akan dihapus?');">Hapus</a>
                    </div>
