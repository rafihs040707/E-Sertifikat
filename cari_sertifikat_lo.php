...
<div class="container-fluid mt-4">
    ...
    <div class="d-flex align-items-center gap-2 flex-wrap">
        ...
        <!-- FORM SEARCH -->
        <form method="GET" action="cari_sertifikat_lo.php" class="col-sm-4 mb-3 ms-4 mt-4">
        ...
        <a href="data_sertifikat_lo.php" class="btn btn-secondary text-decoration-none text-white mt-4 ms-3 mb-2">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="hapus_sertifikat_lo.php?id=<?= $sertifikat['id']; ?>" class="btn btn-sm btn-danger text-white mt-1"
                ...
                <div class="card mb-2 border-primary shadow-sm">
                    <div class="card-body p-2">
                        ...
                        <div class="d-flex gap-1 mt-2 flex-wrap">
                            <a href="edit_sertifikat_lo.php?id=<?= $sertifikat['id']; ?>" class="btn btn-sm btn-warning text-white w-100">Edit</a>

                            <a href="hapus_sertifikat_lo.php?id=<?= $sertifikat['id']; ?>" class="btn btn-sm btn-danger text-white w-100"
                                onclick="return confirm('Apakah yakin data sertifikat ini akan dihapus?');">Hapus</a>
