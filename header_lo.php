...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #0D492D;">
        <div class="container-fluid">
            <a class="navbar-brand" href="./dashboard_lo.php"><img src="./image/logo.png"
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link text-white active" aria-current="page" href="./dashboard_lo.php">Beranda</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" aria-current="page" href="./data_sertifikat_lo.php">Data Sertifikat</a>
                    </li>
                </ul>
